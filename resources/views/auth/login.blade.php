...
<body>
    <div class="login-page">
        ...
        <div class="login-card">
            ...
            @if($errors->any())
            <div class="alert alert-danger py-2 px-3 rounded-3 mb-3" style="font-size:13px; border:none; background:var(--danger-bg); color:var(--danger-dark);">
            ...
            @if(session('success'))
            <div class="alert alert-success py-2 px-3 rounded-3 mb-3" style="font-size:13px; border:none; background:var(--success-bg); color:var(--success-dark);">
            ...
            <form method="POST" action="{{ url('/login') }}">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="remember" style="font-size:13px; color:var(--text-secondary);">Ingat Saya</label>
                    </div>
                </div>
