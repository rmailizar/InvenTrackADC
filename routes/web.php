...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard')->middleware('userAkses:admin,manager');
    ...
    Route::post('users/{id}/reject-account', [UserController::class, 'rejectUser'])->name('users.rejectAccount')->middleware('userAkses:manager');

    // Pending users list for manager
    Route::get('/pending-users', [UserController::class, 'index'])->name('pendingUsers.index')->middleware('userAkses:manager');
    ...
    Route::get('/reports/export', [ReportController::class, 'export'])->name('reports.export')->middleware('userAkses:admin,manager');
